...
const EditActionNote = ({navigation, route}: {navigation:any, route:any}) =>{
    ...
    const handleSaveNote = ()=>{
        db.transaction(tx =>
            tx.executeSql(`UPDATE Action SET Note = (?) WHERE ID =(?)`, [note, route.params.id])
        );
        db.transaction(tx => tx.executeSql(`SELECT * FROM Action 
